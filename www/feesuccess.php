			...
			<div id="content">
				<?php
					...
					if ($itemname == "Choir Fees")
					{
						...
						{
							$sql = "INSERT INTO PayPal(txn_id, item_name, response) VALUES('".$txn_id."','".$itemname."','".$blob."')";
							mysql_query($sql);
						}

						echo ("<p><h3>Thanks for your payment</h3></p>");
						echo ("<p>".$option_selection1."</p>");
						echo ("<p>Name: ".$option_selection2."</p>");
						echo ("<p>Txn ID: ".$txn_id."</p>");
					}
					else
					{
						$sql = "select * from Ticket where TxnToken='". $txn_id ."'";

						$rs = mysql_query($sql);

						if( mysql_num_rows($rs) == 0 )
						{
							$sql = "INSERT INTO Ticket(TicketCode, TxnToken, Tickets) VALUES('".v5()."','".$txn_id."','".$qty."')";
							mysql_query($sql);
